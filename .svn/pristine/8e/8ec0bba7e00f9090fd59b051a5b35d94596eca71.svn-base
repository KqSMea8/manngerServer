...
import com.lmxf.post.alipay.services.sign.RSA;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	...
        	mysign = RSA.sign(prestr, AlipayConfig.key_xmn, AlipayConfig.input_charset);
        }
        return mysign;
    }
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form target=\"blank\" id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfig.partner_xmn + "&_input_charset" +AlipayConfig.input_charset;
