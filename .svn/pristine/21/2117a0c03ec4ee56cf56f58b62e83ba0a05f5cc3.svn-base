...
public class XxteaUtils {
	    ...
	    public static String decryptStr(String hexStr, String charset, String key)
	        ...
	        byte[] bytes = decrypt(Base64.decodeBase64(hexStr), key.getBytes(charset));;
	        return new String(bytes, charset);
	    }

	    /* -------------------------------自定义方法结束----------------------------------- */
	public static void main(String[] args) throws Exception {
	        String str = "ab23e武汉321432143214321432134gdgdfgfd";
	        String key = "flds武汉djs";

	        String hexResult = XxteaUtils.encryptStr(str, "utf-8", key);
	        System.out.println("myencrypt: " + hexResult);
	        str = XxteaUtils.decryptStr(hexResult, "utf-8", key);
