...
public class TradeOrderPayService extends TradeProcess {
	...
	public String tradeProcess(String apply_xml) {
		...
		if (orderApplyR.getSaleChannel().equals(GParameter.saleChannel_weChatGTerminal) && (orderApplyR.getPayType().equals(GParameter.payType_weChatG) || orderApplyR.getPayType().equals(GParameter.payType_weChatApp))) {
			// 申请支付
